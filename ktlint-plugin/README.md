...
The plugin currently runs with ktlint version `1.6.0` by default (see ktlint preferences to alter the ruleset version). K2 mode is supported starting from Intellij IDEA version 2024.2.1.
