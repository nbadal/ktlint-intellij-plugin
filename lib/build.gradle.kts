...
dependencies {
    api("com.pinterest.ktlint:ktlint-core:0.47.0") {
        exclude("org.slf4j")
    }
    implementation("com.pinterest.ktlint:ktlint-ruleset-standard:0.47.0") {
        exclude("org.slf4j")
    }
    implementation("com.pinterest.ktlint:ktlint-ruleset-experimental:0.47.0") {
        exclude("org.slf4j")
    }
}
